  ...
  <div class="bg-white dark:bg-[#1d1d1d]">
    <div class="w-9/12 mx-auto">
      <div class="container mx-auto p-8">
        <img :src="`${post.meta.image}`" alt="Build a Site Blog" class="w-full h-full" />

        <h1 class="text-4xl md:text-5xl mt-8 font-bold drop-shadow-lg text-black dark:text-white">{{ post.title }}
        </h1>
