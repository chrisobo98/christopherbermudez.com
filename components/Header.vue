<template>
    <header :class="{ 'header-scrolled': scrolled }" class="main-header bg-[#1d1d1d]">
      <nav class="bg-transparent border-gray-200 dark:border-gray-600 dark:bg-gray-900 transition-all duration-500">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
          ...
          <!-- Language Selector and Appointment Button -->
        ...
        <div v-if="megaMenuOpen" id="mega-menu-full-dropdown" class="mt-1 border-purple-500 shadow-sm bg-gray-50 md:bg-violet-600 border-y dark:bg-gray-800 dark:border-gray-600 transition-transform transform">
