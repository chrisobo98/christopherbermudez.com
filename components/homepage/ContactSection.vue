<template>
  <section class="py-12 bg-white dark:bg-[#1d1d1d]">
      ...
      <GSAPStaggeredEffect>
        ...
        <div v-for="field in fields" :key="field.id" class="mb-5">
          ...
          <div v-if="field.type === 'text' || field.type === 'email' || field.type === 'url'" class="relative">
            ...
            <input :type="field.type" :id="field.id" v-model="form[field.id as keyof FormData]"
          ...
          <div v-else>
            <textarea :id="field.id" v-model="form[field.id as keyof FormData]" :placeholder="field.placeholder"
              rows="4"
    ...
    <Notification v-if="notification.show" :message="notification.message" :type="notification.type" :duration="5000" />
  </section>
</template>
